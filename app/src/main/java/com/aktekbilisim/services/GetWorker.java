...
public class GetWorker extends AsyncTask<String, Integer, String> {

    private final onAsyncTaskListener listener;
    private Context ctx;

    public GetWorker(Context ctx, onAsyncTaskListener listener) {
    ...
    protected String doInBackground(String... query) {
        try {
            ...
            String jsonStr = sh.makeServiceCall(query[0], ServiceHandler.GET);
